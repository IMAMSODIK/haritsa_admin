                    ...
                    <div class="card h-100 shadow-sm promo-card" style="cursor:pointer"
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mb-2">
                                ...
                                @else
                                    <span class="badge bg-primary">
                                        Diskon Rp {{ number_format($promo['discountValue']) }}
                                    </span>
                                @endif
                            </div>
                            ...
                            <small class="text-muted">
                                Min belanja: Rp {{ number_format($promo['minPurchase']) }}<br>
                                Maks diskon: Rp {{ number_format($promo['maxDiscount']) }}
                            </small>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <select class="form-control" id="promo_discountType">
                            ...
                            <div class="col mb-3">
                                ...
                                <input class="form-control" id="promo_discountValue">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input class="form-control rupiah" id="promo_minPurchase">
                            </div>

                            <div class="col mb-3">
                                <label class="form-label">Maks Diskon</label>
                                <input class="form-control rupiah" id="promo_maxDiscount">
                            </div>
                        </div>
                ...
                <form id="editPromoForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">Tipe Diskon</label>
                                <select class="form-control" id="edit_promo_discountType">
                                    <option value="PERCENTAGE">Percentage (%)</option>
                                    <option value="FIXED">Fixed (Rp)</option>
                                </select>
                            </div>
                            <div class="col mb-3">
                                <label class="form-label">Nilai Diskon</label>
                                <input type="number" class="form-control" id="edit_promo_discountValue">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">Minimum Pembelian</label>
                                <input type="text" class="form-control rupiah" id="edit_promo_minPurchase">
                            </div>
                            <div class="col mb-3">
                                <label class="form-label">Maks Diskon</label>
                                <input type="text" class="form-control rupiah" id="edit_promo_maxDiscount">
                            </div>
                        </div>
