        ...
        <div class="row mb-4">
            <div class="col-12 d-flex justify-content-end">
                <button class="btn btn-success" style="margin-right: 5px" data-bs-toggle="modal"
                    ...
                    <i class="fa fa-upload"></i> Import Kategori Produk
                </button>
    ...
    <div class="modal fade" id="modalImport">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Import Kategori Produk Excel</h5>
                ...
                <form id="importBrandForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 text-center">
                            <a href="{{ route('kategori.template') }}" class="btn btn-outline-primary w-100">
